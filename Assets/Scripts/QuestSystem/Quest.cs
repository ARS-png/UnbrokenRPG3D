...
public class Quest
{
    ...
    public Quest(QuestInfoSO questInfo, QuestState questState, int currentQuestStepIndex, QuestStepState[] questStepStates)
    {
        ...
        if (this.questStepStates.Length != this.info.questStepPrefabs.Length)
        {
            Debug.LogWarning($"Quest Step Prefabs and Quest Step States are of different lengths. " +
                ...
                $"Reset your data - as this might cause issues. Quest Id: {this.info.QuestID}");
        }
    }
    ...
    public bool CurrentQuestExists()
    {
    ...
    private GameObject GetCurrentQuestStepPrefab()
    {
        ...
        {
            Debug.LogWarning("Tried to get quest step prefab, but step index is out fo rangeS");
        }
    ...
    public void StoreQuestStepState(QuestStepState questStepState, int stepIndex)
    {
        ...
        else
        {
            Debug.LogWarning($"Tried to access quest step data, but stepIndex was out of range " +
                $"QuestId:{info.QuestID}, StepIndex = {stepIndex}");
        }
    }
